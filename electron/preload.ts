...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  aiReply: {
    ...
    getSenderConfig: () => ipcRenderer.invoke('aiReply:getSenderConfig'),
    setSenderConfig: (config: any) => ipcRenderer.invoke('aiReply:setSenderConfig', config),
    getSenderHealth: (senderId?: string) => ipcRenderer.invoke('aiReply:getSenderHealth', senderId),
    ...
    setAutoReply: (enabled: boolean) => ipcRenderer.invoke('aiReply:setAutoReply', enabled),
    getAutoReply: () => ipcRenderer.invoke('aiReply:getAutoReply'),
    ...
    getReplyLogs: (limit?: number, offset?: number) => ipcRenderer.invoke('aiReply:getReplyLogs', limit, offset),
    getReplyLogsCount: () => ipcRenderer.invoke('aiReply:getReplyLogsCount'),
    clearReplyLogs: () => ipcRenderer.invoke('aiReply:clearReplyLogs'),
    deleteReplyLogs: (ids: string[]) => ipcRenderer.invoke('aiReply:deleteReplyLogs', ids),
